...
export const Questions = () => {
  ...
  return (
    <div>
      ...
      <div onClick={() => !isResultsActive ? setOpen(true): {}} className="m-auto flex justify-center max-w-[1400px] mx-auto px-8 md:px-20 md:justify-end">
        <Button link={isResultsActive ? '/results' : ''} text={'Resultados'} icon />
      </div>
      <Bento />
      <Modal />
